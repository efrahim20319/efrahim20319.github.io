...
let aCounter = document.querySelector("#aCounter")
setInterval(() => {
    aCounter.innerHTML = Number(aCounter.innerHTML) + 1;
}, 1000);
...
span2.innerHTML = localStorage.getItem("counterInc") || "23";

document.querySelector("button#toCountBtn")
    .addEventListener("click", function () {
        span2.innerHTML = Number(span2.innerHTML) + 1;
        localStorage.setItem("counterInc", span2.innerHTML);
    })
...
document.querySelector("form")
    .addEventListener("submit", (e) => {
        ...
        p.textContent = `Olá, o${personName.value} tem ${personAge.value}`
